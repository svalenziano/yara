...
def generate_embeddings(batch_size=100):
    ...
    try:
        ...
        for i in range(0, len(book_chapters), batch_size):
            ...
            e.g.
                [
                    "Intro to Command Line: Getting Started", 
                    "Intro to Command Line: Basic Operations", 
                    ...
                ]
            """
            batch_metadata = []
            ...
            e.g.
                [
                    {
                        book_title: Intro to Command Line,
                        chapter_title: Getting Started,
                        chapter_url: http://launchschool.com/books/command_line/read/getting_started
                        content: Intro to Command Line: Getting Started
                    },
                    ...
                ]
            """

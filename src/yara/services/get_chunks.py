...
def query_similar_chunks(query_text: str, project_id: int, top_k=10) -> list[SimilarChunk]:
    """
    ...
    with tracer.start_as_current_span(
        ...
        results = get_similar_chunks(query_vector, top_k=top_k, project_id=project_id)

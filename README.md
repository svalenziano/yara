...
### Aside: AI-assisted coding
Like most humans on Earth, I'm still trying to figure out when and how to use AI effectively.  The below diagram is my attempt at recording my thoughts on how AI usage should vary depending on **what I'm doing (workflows)** and **why I'm doing it (goals)**.  This is just a fragment of an idea and I'm hoping someone will / has already evolved this idea into a more coherent one.

![](docs/img/ai_usage_framework.excalidraw.png)
